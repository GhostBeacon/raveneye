// Vertrauensanker fuer TLS: ISRG Root X1 + X2 (Let's Encrypt).
// Quelle: https://letsencrypt.org/certificates/ - SHA-256 geprueft am 25.09.2026:
...
// Reicht fuer ntfy.sh und alles hinter Caddy (Let's Encrypt).
#pragma once
